...
\address{\textbf{Engineer and Software Developer}}{}{}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\social[telegram]{milad\_molaee}                            % optional, remove / comment the line if not wanted
...
\section{Education}
\cventry{}{B.Sc.}{Amirkabir University of Technology}{Tehran, Iran}{\textit{Polymer Engineering}}{}  % arguments 3 to 6 can be left empty
